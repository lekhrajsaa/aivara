...
<div className={classes.dropdown}>
  <button className={classes.dropbtn}>  <img src="/user.svg" ></img></button>
  <div className={classes.dropdown_content}>
    ...
    <a href="#">Help & Support</a>
      ...
      <Container className={classes.report}><h6 className={classes.heading}>History of the analyzed reports</h6>
     <div >
     {array.map((a,i)=>{
